...
//  RooFitResult* fitRes = sig->fitTo(*data_fit, Hesse(0), Verbose(1), NumCPU(NoCPU), Strategy(1), Timer(1), Minimizer("Minuit","Migrad"),  Save(), SumW2Error(0));
  ...
  TTree *fChain = (TTree*)flhcbmc->Get("DecayTreeTuple/DecayTree");
   ...
   Double_t        M1_TRUEP_Z;
   Double_t        M1_TRUEPT;
   Double_t        M1_TRUEORIGINVERTEX_X;
   Double_t        M1_TRUEORIGINVERTEX_Y;
   Double_t        M1_TRUEORIGINVERTEX_Z;
   Double_t        M1_TRUEENDVERTEX_X;
   Double_t        M1_TRUEENDVERTEX_Y;
   Double_t        M1_TRUEENDVERTEX_Z;
   Bool_t          M1_TRUEISSTABLE;
   Double_t        M1_TRUETAU;
   Int_t           M2_TRUEID;
   Double_t        M2_TRUEP_E;
   Double_t        M2_TRUEP_X;
   ...
   Double_t        M2_TRUEP_Z;
   Double_t        M2_TRUEPT;
   Double_t        M2_TRUEORIGINVERTEX_X;
   Double_t        M2_TRUEORIGINVERTEX_Y;
   Double_t        M2_TRUEORIGINVERTEX_Z;
   Double_t        M2_TRUEENDVERTEX_X;
   Double_t        M2_TRUEENDVERTEX_Y;
   Double_t        M2_TRUEENDVERTEX_Z;
   Bool_t          M2_TRUEISSTABLE;
   Double_t        M2_TRUETAU;
   Int_t           Kst_TRUEID;
   ...
   TBranch        *b_M1_TRUEID;   //!
   TBranch        *b_M1_TRUEP_E;   //!
   TBranch        *b_M1_TRUEP_X;   //!
   TBranch        *b_M1_TRUEP_Y;   //!
   TBranch        *b_M1_TRUEP_Z;   //!
   TBranch        *b_M1_TRUEPT;   //!
   TBranch        *b_M1_TRUEORIGINVERTEX_X;   //!
   TBranch        *b_M1_TRUEORIGINVERTEX_Y;   //!
   TBranch        *b_M1_TRUEORIGINVERTEX_Z;   //!
   TBranch        *b_M1_TRUEENDVERTEX_X;   //!
   TBranch        *b_M1_TRUEENDVERTEX_Y;   //!
   TBranch        *b_M1_TRUEENDVERTEX_Z;   //!
   TBranch        *b_M1_TRUEISSTABLE;   //!
   TBranch        *b_M1_TRUETAU;   //!
   TBranch        *b_M2_TRUEID;   //!
   TBranch        *b_M2_TRUEP_E;   //!
   TBranch        *b_M2_TRUEP_X;   //!
   TBranch        *b_M2_TRUEP_Y;   //!
   TBranch        *b_M2_TRUEP_Z;   //!
   TBranch        *b_M2_TRUEPT;   //!
   TBranch        *b_M2_TRUEORIGINVERTEX_X;   //!
   TBranch        *b_M2_TRUEORIGINVERTEX_Y;   //!
   TBranch        *b_M2_TRUEORIGINVERTEX_Z;   //!
   TBranch        *b_M2_TRUEENDVERTEX_X;   //!
   TBranch        *b_M2_TRUEENDVERTEX_Y;   //!
   TBranch        *b_M2_TRUEENDVERTEX_Z;   //!
   TBranch        *b_M2_TRUEISSTABLE;   //!
   TBranch        *b_M2_TRUETAU;   //!
   ...
   fChain->SetBranchAddress("M1_TRUEID", &M1_TRUEID, &b_M1_TRUEID);
   fChain->SetBranchAddress("M1_TRUEP_E", &M1_TRUEP_E, &b_M1_TRUEP_E);
   fChain->SetBranchAddress("M1_TRUEP_X", &M1_TRUEP_X, &b_M1_TRUEP_X);
   fChain->SetBranchAddress("M1_TRUEP_Y", &M1_TRUEP_Y, &b_M1_TRUEP_Y);
   fChain->SetBranchAddress("M1_TRUEP_Z", &M1_TRUEP_Z, &b_M1_TRUEP_Z);
   fChain->SetBranchAddress("M1_TRUEPT", &M1_TRUEPT, &b_M1_TRUEPT);
   fChain->SetBranchAddress("M1_TRUEORIGINVERTEX_X", &M1_TRUEORIGINVERTEX_X, &b_M1_TRUEORIGINVERTEX_X);
   fChain->SetBranchAddress("M1_TRUEORIGINVERTEX_Y", &M1_TRUEORIGINVERTEX_Y, &b_M1_TRUEORIGINVERTEX_Y);
   fChain->SetBranchAddress("M1_TRUEORIGINVERTEX_Z", &M1_TRUEORIGINVERTEX_Z, &b_M1_TRUEORIGINVERTEX_Z);
   fChain->SetBranchAddress("M1_TRUEENDVERTEX_X", &M1_TRUEENDVERTEX_X, &b_M1_TRUEENDVERTEX_X);
   fChain->SetBranchAddress("M1_TRUEENDVERTEX_Y", &M1_TRUEENDVERTEX_Y, &b_M1_TRUEENDVERTEX_Y);
   fChain->SetBranchAddress("M1_TRUEENDVERTEX_Z", &M1_TRUEENDVERTEX_Z, &b_M1_TRUEENDVERTEX_Z);
   fChain->SetBranchAddress("M1_TRUEISSTABLE", &M1_TRUEISSTABLE, &b_M1_TRUEISSTABLE);
   fChain->SetBranchAddress("M1_TRUETAU", &M1_TRUETAU, &b_M1_TRUETAU);
   fChain->SetBranchAddress("M2_TRUEID", &M2_TRUEID, &b_M2_TRUEID);
   fChain->SetBranchAddress("M2_TRUEP_E", &M2_TRUEP_E, &b_M2_TRUEP_E);
   fChain->SetBranchAddress("M2_TRUEP_X", &M2_TRUEP_X, &b_M2_TRUEP_X);
   fChain->SetBranchAddress("M2_TRUEP_Y", &M2_TRUEP_Y, &b_M2_TRUEP_Y);
   fChain->SetBranchAddress("M2_TRUEP_Z", &M2_TRUEP_Z, &b_M2_TRUEP_Z);
   fChain->SetBranchAddress("M2_TRUEPT", &M2_TRUEPT, &b_M2_TRUEPT);
   fChain->SetBranchAddress("M2_TRUEORIGINVERTEX_X", &M2_TRUEORIGINVERTEX_X, &b_M2_TRUEORIGINVERTEX_X);
   fChain->SetBranchAddress("M2_TRUEORIGINVERTEX_Y", &M2_TRUEORIGINVERTEX_Y, &b_M2_TRUEORIGINVERTEX_Y);
   fChain->SetBranchAddress("M2_TRUEORIGINVERTEX_Z", &M2_TRUEORIGINVERTEX_Z, &b_M2_TRUEORIGINVERTEX_Z);
   fChain->SetBranchAddress("M2_TRUEENDVERTEX_X", &M2_TRUEENDVERTEX_X, &b_M2_TRUEENDVERTEX_X);
   fChain->SetBranchAddress("M2_TRUEENDVERTEX_Y", &M2_TRUEENDVERTEX_Y, &b_M2_TRUEENDVERTEX_Y);
   fChain->SetBranchAddress("M2_TRUEENDVERTEX_Z", &M2_TRUEENDVERTEX_Z, &b_M2_TRUEENDVERTEX_Z);
   fChain->SetBranchAddress("M2_TRUEISSTABLE", &M2_TRUEISSTABLE, &b_M2_TRUEISSTABLE);
   fChain->SetBranchAddress("M2_TRUETAU", &M2_TRUETAU, &b_M2_TRUETAU);
 ...
 // numevt = 100;
  for(Long64_t i=0; i<numevt; ++i) {
    ...
    if(abs(B0_TRUEID)==5122)  {
      ...
      TLorentzVector p[4];
      Int_t id[4];
      p[0] = TLorentzVector(M1_TRUEP_X,M1_TRUEP_Y,M1_TRUEP_Z,M1_TRUEP_E); id[0] = M1_TRUEID;
      p[1] = TLorentzVector(M2_TRUEP_X,M2_TRUEP_Y,M2_TRUEP_Z,M2_TRUEP_E); id[1] = M2_TRUEID;      
	...
	protonPZ = p[matchid[3]].Pz();
      ...
      if(JPs_TRUEID==443) PJ =  new TLorentzVector(JPs_TRUEP_X, JPs_TRUEP_Y,JPs_TRUEP_Z, JPs_TRUEP_E);      
